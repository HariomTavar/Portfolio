...
import QuickSectionRail from './components/QuickSectionRail'
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-baseBg text-textPrimary">
      ...
      <QuickSectionRail items={portfolioData.nav} onNavigate={handleNavigate} />
      ...
      <main>
        ...
        <ProcessSection process={portfolioData.process} />
